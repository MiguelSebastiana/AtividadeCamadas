...
public class ContatoService {
    ...
    public boolean existByName(String nome) throws SQLException {
    ...
    public boolean existByNumber(String numero) throws SQLException{

        if(numero.isBlank()){
            throw new IllegalArgumentException("O numero nao pode ser vazio");
        }

        return contatoRepository.existePorNumero(numero);
    }
